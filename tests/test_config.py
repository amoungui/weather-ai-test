...
def test_config():
    ...
    print(f"✅ WeatherAI Key: {'Configured' if settings.weather_ai_api_key else 'Not configured'}")
    print(f"✅ OpenWeather Key: {'Configured' if settings.openweather_api_key else 'Not configured'}")
    ...
    try:
        ...
        print(f"✅ Direct import - WeatherAI Key: {'OK' if WEATHER_AI_API_KEY else 'Not configured'}")
