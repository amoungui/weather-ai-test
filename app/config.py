...
def validate_configuration():
    ...
    logger.info(f"   WeatherAI API: {'Configured' if has_weather_ai else 'Not configured'}")
    logger.info(f"   OpenWeather API: {'Configured' if has_openweather else 'Not configured'}")
